    ...
    public class NewOrderViewModel : INotifyPropertyChanged
    {
        ...
        public DateTime NeedBy
        {
            set
            {
                ...
                {
                    _needby = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(NeedBy)));
                }
            }
            get
            {
        ...
        public int SalesOrderHeaderId
        {
            set
            {
                if (_salesorderHeaderId != value)
                {
                    _salesorderHeaderId = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(SalesOrderHeaderId)));
                }
            }
            get
            {
        ...
        public int SalesOrderHeaderInterId
        {
            set
            {
                if (_salesOrderHeaderInterId != value)
                {
                    _salesOrderHeaderInterId = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(SalesOrderHeaderInterId)));
                }
            }
            get
            {
                return _salesOrderHeaderInterId;
            }
        }
        ...
        public bool SincronizadoEpicor
        {
            set
            {
                if (_sincronizadoEpicor != value)
                {
                    _sincronizadoEpicor = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(SincronizadoEpicor)));
                }
            }
            get
            {
                return _sincronizadoEpicor;
            }
        }
        ...
        public bool IsSync
        {
            set
            {
                ...
                {
                    _isSync = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(IsSync)));
                }
            }
            get
            {
        ...
        public string Observations
        {
            set
            {
                ...
                {
                    _observations = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(Observations)));
                }
            }
            get
            {
        ...
        public int OrderNum
        {
            set
            {
                ...
                {
                    _ordernum = value;
                    PropertyChanged?.Invoke(this, new PropertyChangedEventArgs(nameof(OrderNum)));
                }
            }
            get
            {
        ...
        async void SearchCustomer()
        {
            ...
            mainViewModel.EjecutadoDesde = "NewOrderViewModel";
            mainViewModel.NewOrder.ShipTo = null;
        ...
        async void SearchShipTo()
        {
            ...
            var mainViewModel = MainViewModel.GetInstance();
            mainViewModel.NewOrder.Contact = null;
