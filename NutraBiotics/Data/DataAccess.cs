namespace NutraBiotics.Data
{
    ...
    public class DataAccess : IDisposable
	{
		...
		public DataAccess()
		{
            ...
            connection.CreateTable<Territory>();
            ...
            connection.CreateTable<InvoiceHeader>();
            connection.CreateTable<InvoiceDetail>();
            connection.CreateTable<CashHeader>();
            connection.CreateTable<Country>();
            connection.CreateTable<PersonContact>();
            connection.CreateTable<Calendar>();
